...
class IndexPengguna extends Component{
        constructor(props){
            ...
            this.state={
                table:{
                    ...
                    data:[
                         {Nama:"User1",Username:"User1",NIP:"123123123",Email:"Email@email.com",Action:<Link to='Edit/1'>Edit</Link>},
    ...
    render(){
        ...
        const user = redstore.pengguna.user
...
export default compose( connect(
  mapStateToProps,
  { saveUser }), withStyles(useStyles))(IndexPengguna)