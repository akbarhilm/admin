...
class EditAplikasi extends Component{
    constructor(props){
        super(props)
        this.state={
    ...
    render(){
        ...
        <Grid item xs={12}>
          <Typography variant="h5" className={classes.header}>Edit Aplikasi</Typography>
        </Grid>
...
export default compose( connect(
  mapStateToProps,
  { saveApp }), withStyles(useStyles))(EditAplikasi)